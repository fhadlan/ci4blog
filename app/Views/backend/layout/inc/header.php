			...
			<div class="dropdown">
				<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
					<span class="user-icon">
						<img src="/images/users/<?= get_user()->picture == null ? 'default-avatar.webp' : get_user()->picture   ?>" alt="" />
					</span>
				...
				<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
					...
					<a class="dropdown-item" href="<?php echo route_to('admin.logout'); ?>"><i class="dw dw-logout"></i> Log Out</a>
				</div>
			</div>
		</div>
